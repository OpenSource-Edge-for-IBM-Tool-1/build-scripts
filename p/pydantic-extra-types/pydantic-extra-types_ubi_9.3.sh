...
# -----------------------------------------------------------------------------
#
# Package          : pydantic-extra-types
# Version          : v2.9.0
# Source repo      : https://github.com/pydantic/pydantic-extra-types
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=pydantic-extra-types
PACKAGE_VERSION=${1:-v2.9.0}
PACKAGE_URL=https://github.com/pydantic/pydantic-extra-types
PACKAGE_DIR=pydantic-extra-types
