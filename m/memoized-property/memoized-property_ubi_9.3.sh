...
# -----------------------------------------------------------------------------
#
# Package          : memoized-property
# Version          : releases/1.0.2
# Source repo      : https://github.com/estebistec/python-memoized-property
# Tested on     : UBI:9.3
# Language      : Python
# Travis-Check  : True
...
# Variables
PACKAGE_NAME=memoized-property
PACKAGE_VERSION=${1:-releases/1.0.2}
PACKAGE_URL=https://github.com/estebistec/python-memoized-property
PACKAGE_DIR=memoized-property
